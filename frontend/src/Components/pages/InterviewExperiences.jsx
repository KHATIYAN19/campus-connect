...
import { FiBriefcase, FiCalendar, FiUser, FiX, FiAward, FiUsers, FiStar, FiArrowRight } from "react-icons/fi";
      ...
      {show && (
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            >
              <button
                className="bg-indigo-600 text-white py-4 px-8 rounded-full hover:bg-indigo-700 transition-all duration-300 shadow-lg flex items-center gap-3 mx-auto text-lg"
          ...
          {/* Success Story */}
          <div className="bg-indigo-600 text-white rounded-2xl p-8 mb-16 shadow-xl">
            <div className="max-w-4xl mx-auto text-center">
              <FiStar className="text-4xl mb-4 mx-auto" />
              <h3 className="text-2xl font-bold mb-4">How Your Story Helps</h3>
              <p className="text-lg mb-6">
                "Thanks to community-shared experiences, I cracked my Google interview! Detailed insights about the 
                process helped me prepare strategically. Now I'm paying it forward."
              </p>
              <div className="flex items-center justify-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-indigo-100">SDE II @ Google</p>
                </div>
              </div>
            </div>
          </div>
            ...
            >
              <div className="p-6 sm:p-8">
                ...
                <p className={`text-gray-600 leading-relaxed ${expanded === experience._id ? '' : 'line-clamp-3'}`}>
                  {expanded === experience._id ? experience.description : `${experience.description?.slice(0, 100)}...`}
                </p>
        ...
        <div className="max-w-7xl mx-auto mt-16 text-center">
          <div className="bg-white rounded-2xl p-8 shadow-xl border border-indigo-50">
            ...
            <p className="text-gray-600 mb-8 max-w-xl mx-auto">
              ...
              Share your knowledge and help shape careers!
            </p>
            <button
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl border ${formErrors.title ? 'border-red-500' : 'border-gray-200'} focus:ring-2 focus:ring-indigo-500 focus:border-transparent`}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 rounded-xl border ${formErrors.company ? 'border-red-500' : 'border-gray-200'} focus:ring-2 focus:ring-indigo-500 focus:border-transparent`}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 rounded-xl border ${formErrors.experience ? 'border-red-500' : 'border-gray-200'} focus:ring-2 focus:ring-indigo-500 focus:border-transparent`}
                ...
                <div className="flex justify-end gap-4 mt-8">
                  <button
                    type="button"
                    onClick={() => setIsFormVisible(false)}
                    className="px-6 py-2.5 text-gray-600 hover:text-gray-800 rounded-xl transition-colors"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="bg-indigo-600 text-white px-6 py-2.5 rounded-xl hover:bg-indigo-700 transition-colors shadow-sm"
                  >
                    Submit Experience
                  </button>
                </div>
