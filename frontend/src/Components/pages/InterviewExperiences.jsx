...
const InterviewExperiences = ({ show }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      ...
      {!show && (
        <div className='text-green-400 text-center  text-3xl'>Interview Experiences</div>
      )}
          ...
          >
            ...
            <div className="mb-4">
              <div className="flex items-center mb-4">
                ...
                />
                <div className="ml-4">
                  <h2 className="text-xl font-semibold text-gray-800">{experience.postby.name}</h2>
                  <p className="text-sm text-gray-500">{calculateDaysAgo(experience.createdAt)} days ago</p>
                </div>
              </div>
      ...
      {isFormVisible && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-xl w-full sm:w-1/2 lg:w-1/3">
            <button
            ...
            <h2 className="text-2xl font-semibold mb-6 text-center text-gray-800">Share Your Experience</h2>
            <form onSubmit={handleSubmit}>
              <div className="mb-6">
                ...
                <input
                  ...
                  className={`mt-2 block w-full px-6 py-3 border ${
              ...
              <div className="flex justify-between">
                <button
                  type="submit"
                  className="bg-blue-500 text-white py-3 px-6 rounded-full hover:bg-blue-600 transition-all duration-300"
                >
                  Submit
                </button>
                <button
                  type="button"
                  className="bg-red-500 text-white py-3 px-6 rounded-full hover:bg-red-600 transition-all duration-300"
                  onClick={closeForm}
                >
                  Cancel
                </button>
