...
const {signup,user_applications,login,reset,logout,verifytoken,deleteAcc,Adminsignup,user_update,admin_update,my_application,user_profile}=require("../Controllers/Usercontrollers");
